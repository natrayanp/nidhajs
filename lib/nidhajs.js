...
define("ts/nidhajs", ["require", "exports", "d3"], function (require, exports, d3) {
    "use strict";
...
define("ts/baseshapes/leaf_base_shape_circle", ["require", "exports", "../leafshape", "d3"], function (require, exports, leafshape_1, d3) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    d3 = __importStar(d3);
    class base_circle_leaf extends leafshape_1.LeafShape {
...
define("ts/baseshapes/leaf_base_shape_rect", ["require", "exports", "../leafshape", "d3"], function (require, exports, leafshape_2, d3) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    d3 = __importStar(d3);
    class base_rect_leaf extends leafshape_2.LeafShape {
...
define("ts/baseshapes/index", ["require", "exports", "ts/baseshapes/leaf_base_shape_circle", "ts/baseshapes/leaf_base_shape_rect"], function (require, exports, leaf_base_shape_circle_1, leaf_base_shape_rect_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.base_circle_leaf = leaf_base_shape_circle_1.base_circle_leaf;
    exports.base_rect_leaf = leaf_base_shape_rect_1.base_rect_leaf;
});
define("ts/customshapes/custom_dot_leaf", ["require", "exports", "../leafshape", "ts/baseshapes/index"], function (require, exports, leafshape_3, bs) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    bs = __importStar(bs);
    class custom_dot_leaf extends leafshape_3.LeafShape {
        constructor(x, y, prntshape, r) {
            super(x, y, prntshape);
        ...
        create() {
            let msx = this.childshape.push(new bs.base_circle_leaf(0, 0, this, (this.baseshape.radius / 2)));
    ...
    exports.custom_dot_leaf = custom_dot_leaf;
});
define("ts/customshapes/custom_rect_leaf", ["require", "exports", "../leafshape", "ts/baseshapes/index"], function (require, exports, leafshape_4, bs) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    bs = __importStar(bs);
    class custom_rect_leaf extends leafshape_4.LeafShape {
        constructor(x, y, prntshape, w, h) {
            super(x, y, prntshape);
        ...
        create() {
            ...
            this.childshape.push(new bs.base_circle_leaf(/* -->  this is test for BASE shape as child */ (this.baseshape.width), (this.baseshape.height) / 2, this, (this.baseshape.height / 4)));
            //@TESTING CODES
        }
        moving_bare() {
        }
    }
    exports.custom_rect_leaf = custom_rect_leaf;
});
define("ts/customshapes/index", ["require", "exports", "ts/customshapes/custom_dot_leaf", "ts/customshapes/custom_rect_leaf"], function (require, exports, custom_dot_leaf_1, custom_rect_leaf_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.custom_dot_leaf = custom_dot_leaf_1.custom_dot_leaf;
    exports.custom_rect_leaf = custom_rect_leaf_1.custom_rect_leaf;
});
